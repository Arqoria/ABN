...
// Page permanente (voir docs/Tasks.md) : ne pas supprimer/déplacer sans
// validation du client — Aymen l'a validée par conviction personnelle, mais
// le référent association n'a pas encore donné son accord. Reste accessible
// ici indépendamment de la vraie page d'accueil (Étape 10, servie sur '/').
