...
// un rôle pour les activer (voir src/lib/actions/comptes.ts). Voir
// docs/Specs.md : "Validation manuelle obligatoire de tout nouveau compte
// par un Admin avant accès aux fonctionnalités métier."
    ...
    <div className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-4 px-4 py-16">
      <div>
        ...
        <p className="mt-1 text-sm text-muted-foreground">
          Assignez un rôle à chaque nouveau bénévole pour activer son compte.
        </p>
      </div>
      ...
      {!comptesEnAttente || comptesEnAttente.length === 0 ? (
        ...
        comptesEnAttente.map((compte) => (
          <Card key={compte.id}>
            ...
            <CardContent>
              <ValiderCompteForm userId={compte.id} />
            </CardContent>
          </Card>
        ))
      )}
